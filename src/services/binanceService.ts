...
import { getViteEnv, IS_SIMULATION } from "@/utils/env";
...
const BINANCE_BASE_URLS = [
  'https://fapi.binance.info', // Info Mirror (Retornou 429, não 451 - Rota Possível)
...
const VERCEL_PROXY = getViteEnv('VITE_BINANCE_PROXY_URL') || 'https://nexus-crypto-bot.vercel.app/api/binance-proxy';
